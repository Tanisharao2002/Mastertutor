                ...
                return (
                  <div className="card1">
                    ...
                    <div className="cardCol2">
                      ...
                      <p>{teacher.bio || "Bio Not Available"}</p>
                      <Link
                        to={`/Mastertutor/educators/page/:${teacher.uid}`}
                        className="btn2"
                      >
                        Visit Profile
                      </Link>
                              ...
                              <div className="card2P">
                                <div className="card2C">
                                  ...
                                  <p className="heading4">
                                    ...
                                    reprehenderit impedit ab laborum facere aut
                                    natus perferendis eos omnis facere est
                                    dolorum unde et autem illum qui ratione
                                    rerum. Eos nemo repellendus id quos ipsa et
                                    aperiam molestiae.
                                  </p>
                                </div>
                              </div>
      ...
      <div className="mainTutor">
        <div className="mainTutorBox">
          <div className="mainTutorR1">
            <img src={profile} className="mainTutorImg" />
            <div className="mainTutorC1 ">
              <p className="pname">{teacherId.name}</p>
              <p className="bio">{teacherId.bio}</p>
              <p className="bio">{teacherId.totalCourses}</p>
              <p className="bio">{teacherId.experience}</p>
            </div>
          </div>
